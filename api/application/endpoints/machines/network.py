...
def __save_flow_state__(positions: Positions, current_user: DependsOnAuthentication) -> None:
...
def __get_user_snapshots__(current_user: DependsOnAuthentication) -> list[Snapshot]:
...
def __create_snapshot__(snapshot: Snapshot, current_user: DependsOnAuthentication) -> Snapshot:
