...
const createNode = (type, data, position) => {
    switch (type) {
        case MachineNode:
            return createMachineNode(data, position);
        case IntnetNode:
            return createIntnetNode(data, position);
        default:
            return {};
    }
};
...
export const createMachineNode = (machine, position) => ({
    ...
    data: {
        ...
        icon: machine.group === "desktop" ? IconDeviceDesktop : machine.group === "server" ? IconServer2 : IconPlayerRecord,
    },
});
